...
int stm32_w25initialize(int minor)
{
  ...
  const char *partname = CONFIG_WEACTSTM32F103_FLASH_PART_NAMES;
#endif
...
#ifdef CONFIG_WEACTSTM32F103_FLASH_PART
    {
      int partno;
      int partsize;
      int partoffset;
      int partszbytes;
      int erasesize;
      const char *partstring = CONFIG_WEACTSTM32F103_FLASH_PART_LIST;
      const char *ptr;
...
#ifdef CONFIG_WEACTSTM32F103_FLASH_CONFIG_PART
          /* Test if this is the config partition */

          if (CONFIG_WEACTSTM32F103_FLASH_CONFIG_PART_NUMBER == partno)
            {
...
#endif
            {
              ...
              smart_initialize(CONFIG_WEACTSTM32F103_FLASH_MINOR,
                               mtd_part, partref);
#endif
            }
...
#else /* CONFIG_WEACTSTM32F103_FLASH_PART */

  /* Configure the device with no partition support */

  smart_initialize(CONFIG_WEACTSTM32F103_FLASH_MINOR, mtd, NULL);

#endif /* CONFIG_WEACTSTM32F103_FLASH_PART */
