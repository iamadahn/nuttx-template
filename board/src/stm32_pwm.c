...
#if !defined(CONFIG_STM32_TIM3_CHANNEL) || CONFIG_STM32_TIM3_CHANNEL != WEACTSTM32F103_PWMCHANNEL
#  undef HAVE_PWM
#endif
  ...
  if (!initialized)
    {
      ...
      pwm = stm32_pwminitialize(WEACTSTM32F103_PWMTIMER);
      if (!pwm)
        {
